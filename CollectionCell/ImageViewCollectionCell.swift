...
final class ImageViewCollectionCell: UICollectionViewCell {
    private lazy var imageViewColection : UIImageView = {
    ...
    override func prepareForReuse() {
            ...
            imageViewColection.image = nil
        }
    private func configureView() {
        contentView.addSubview(imageViewColection)
        imageViewColection
        ...
        NetworkManager.shared.loadData(urlString: data, completion:{
            ...
            case .success(let data):
                DispatchQueue.main.async{
                    self.imageViewColection.image = UIImage(data: data)
                }
